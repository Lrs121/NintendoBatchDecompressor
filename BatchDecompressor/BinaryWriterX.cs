...
namespace BatchDecompressor
{
	public class BinaryWriterX : BinaryWriter
	{
		...
		public BinaryWriterX(Stream input, Encoding encoding, ByteOrder byteOrder = ByteOrder.LittleEndian) : base(
			input, encoding)
		{
			ByteOrder = byteOrder;
		}

		public BinaryWriterX(Stream input, Encoding encoding, bool leaveOpen,
		...
		public BinaryWriterX(Stream input, bool leaveOpen, ByteOrder byteOrder = ByteOrder.LittleEndian) : base(input,
		...
		{
			Write(item.StructToBytes(ByteOrder));
		}
		...
		public void WriteAlignment(byte alignmentByte)
		{
			WriteAlignment(16, alignmentByte);
		}
	}
}